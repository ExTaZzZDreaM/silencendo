import { unifiedSearch } from "../../../unified-search/manager.js";
...
function coerceParams(args) {
    ...
    const filters = filtersRaw && typeof filtersRaw === "object" ? filtersRaw : undefined;
    return {
        query: a.query,
        scope: scope,
        limit,
    ...
    for (const line of input.split("\n")) {
        ...
        try {
            ...
            if (msg.method === "tools/call") {
                ...
                const results = await unifiedSearch(params, providers);
                respond(msg.id, {
