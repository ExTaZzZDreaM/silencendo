...
export const testimonials: Testimonial[] = [
	{
		...
		quote: "S-CODE is an absolute game-changer! 🚀 It makes coding faster, easier, and more intuitive with its smart AI-powered suggestions, real-time debugging, and automation features. The seamless integration with VS Code is a huge plus, and the constant updates ensure it keeps getting better",
		stars: 5,
	},
	{
		...
		origin: "Vendidit",
		quote: "Easily the best AI code editor. S-CODE has the best features and capabilities, along with the best development team. I swear, they're the fastest to support new models and implement useful functionality whenever users mention it... simply amazing.",
	},
	{
		name: "Can Nuri",
		role: "Reviewer",
		origin: "VS Code Marketplace",
		quote: "S-CODE is one of the most inspiring projects I have seen for a long time. It shapes the way I think and deal with software development.",
		stars: 5,
	},
	{
		name: "Michael",
		role: "Reviewer",
		origin: "VS Code Marketplace",
		quote: "I switched from Windsurf to S-CODE in January and honestly, it's been a huge upgrade. Windsurf kept making mistakes and being dumb when I ask it for things. S-CODE just gets it. Projects that used to take a full day now wrap up before lunch. ",
		stars: 5,
	},
	{
		name: "Darien Hardin",
	...
	},
	{
		...
		role: "Reviewer",
		origin: "VS Code Marketplace",
		quote: "I work inside S-CODE about 60+ hours a week and usually roo is building something at all hours of the day. An amazing tool by an amazing team!",
		stars: 5,
	},
	{
		name: "Matthew Martin",
	...
	},
	{
		...
		role: "Reviewer",
		origin: "VS Code Marketplace",
		quote: "S-CODE is impressively capable while staying refreshingly simple. It integrates seamlessly into VS Code and handles everything from generating code to refactoring with accuracy and speed. It feels like a natural part of the workflow—no clutter, just results. Extra points for the flexibility of the different agents and the ability to customize them to fit the job.",
		stars: 5,
	},
	{
		name: "Colin Tate",
	...
	},
	{
		...
		role: "Reviewer",
		origin: "VS Code Marketplace",
		quote: "I've used all the IDEs and all the assistants - S-CODE is hands down the best of them. It's also one of the few that lets you bring your own API keys - no subscriptions required, just pay as you need/go! Fantastic team and support as well!",
		stars: 5,
	},
]
			...
			<div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
				<div className="mx-auto mb-8 md:max-w-2xl text-center">
					<h2 className="text-4xl font-bold tracking-tight sm:text-5xl">
						More than 1 million people are shipping with S-CODE.
					</h2>
