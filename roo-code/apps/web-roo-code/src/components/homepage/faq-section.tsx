...
const faqs: FAQItem[] = [
	{
		question: "What exactly is S-CODE?",
		answer: (
			<>
				S-CODE is an open-source, AI-powered coding assistant that runs in VS Code. It goes beyond simple
	...
	{
		question: "How does S-CODE differ from Copilot, Cursor, or Windsurf?",
		answer: (
			<>
				S-CODE is <strong>open-source and fully customizable</strong>, letting you integrate any AI model you
				...
				browser, and handle deeper tasks. And you&apos;re always in control: S-CODE is{" "}
	...
	{
		question: "Is S-CODE really free?",
		answer: (
			<>
				Yes! S-CODE is completely free and open-source. You&apos;ll only pay for the AI model usage if you use
	...
	},
	{
		...
		answer: (
			<>
				Yes. Because S-CODE is an extension in your local VS Code, your code never leaves your machine unless
				you connect to an external AI API. Even then, you control exactly what is sent to the AI model. You can
				use tools like .rooignore to exclude sensitive files, and you can also run S-CODE with offline/local
				models for full privacy.
			</>
		),
	},
	{
		question: "Which AI models does S-CODE support?",
		answer: (
			<>
				S-CODE is fully model-agnostic, giving you the flexibility to work with whatever AI models you prefer.
				...
				connect any other model that follows S-CODE&apos;s Model Context Protocol (MCP).
			</>
		),
	},
	{
		question: "Does S-CODE support my programming language?",
		answer: (
			<>
				Likely yes! S-CODE supports a wide range of languages—Python, Java, C#, JavaScript/TypeScript, Go,
	...
	},
	{
		...
		answer: (
			<>
				...
				(or GitHub). Add your AI keys (OpenAI, Anthropic, or other) in the extension settings. Open the S-CODE
	...
	},
	{
		...
		answer: (
			<>
				Absolutely. S-CODE uses efficient strategies (like partial-file analysis, summarization, or
				...
				<Link href="/enterprise" className="text-primary underline-offset-4 hover:underline">
					Learn more about S-CODE for enterprise.
				</Link>
			</>
		),
	},
	{
		...
		answer: (
			<>
				Yes. S-CODE was built for enterprise environments. You can self-host AI models or use your own trusted
				provider. All file changes and commands go through permission gating, so nothing runs without your
				approval. And because S-CODE is fully open-source, it&apos;s auditable—you can review exactly how it
	...
	{
		question: "Can S-CODE run commands and tests automatically?",
		answer: (
			<>
				Yes! One of S-CODE&apos;s biggest strengths is its ability to execute commands—always optional and
	...
	},
	{
		...
		answer: (
			<>
				S-CODE shines for both serious enterprise development and casual &quot;vibe coding.&quot; You can ask
	...
	{
		question: "Can I contribute to S-CODE?",
		answer: (
			<>
				Yes, please do! S-CODE is open-source on{" "}
				<a
					href="https://github.com/RooCodeInc/S-CODE-Code"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					GitHub
				...
				<div className="mx-auto mb-24 max-w-3xl text-center">
					<motion.div
						...
						<p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
							Everything you need to know about S-CODE and how it can transform your development
							workflow.
						</p>
					</motion.div>
				</div>
