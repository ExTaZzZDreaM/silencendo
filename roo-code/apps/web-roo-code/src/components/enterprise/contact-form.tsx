...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping S-CODE's enterprise solution."
			: "Fill out the form below to see S-CODE's enterprise capabilities in action."
