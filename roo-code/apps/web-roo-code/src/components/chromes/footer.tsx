				...
				<div className="xl:grid xl:grid-cols-3 xl:gap-8">
					<div className="space-y-8">
						<div className="flex items-center">
							<Image src={logoSrc} alt="S-CODE Logo" width={120} height={40} className="h-6 w-auto" />
						</div>
						...
						<a
							...
							<Image
								src={resolvedTheme === "light" ? "/slnc-code-badge-blk.svg" : "/slnc-code-badge-white.svg"}
								alt="Made with S-CODE"
								width={120}
								height={40}
