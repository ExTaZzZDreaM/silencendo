...
export const content: AgentPageContent = {
	...
	hero: {
		...
		paragraphs: [
			...
			"S-CODE's PR Reviewer uses advanced reasoning models and full repository context to find the issues that slip through—before they reach production.",
		],
		image: {
			url: hero.src,
			width: 800,
			height: 474,
			alt: "Example of a code review generated by S-CODE PR Reviewer",
		},
		crossAgentLink: {
	...
	howItWorks: {
		...
		steps: [
			...
			},
			{
				...
				description:
					"Every pull request gets detailed GitHub comments in minutes from a S-CODE agent highlighting issues and suggesting improvements.",
				icon: "MessageSquareCode",
			},
		],
	},
	whyBetter: {
		heading: "Why S-CODE's PR Reviewer is different",
		features: [
			{
				...
				paragraphs: [
					...
					"With S-CODE, you bring your own API key. We optimize prompts for depth, not cost-cutting, so reviews focus on real problems like business logic, security vulnerabilities, and architectural issues.",
				],
				icon: "Blocks",
			},
			{
			...
			},
			{
				...
				description:
					"S-CODE analyzes your entire codebase context—dependency graphs, code ownership, team conventions, and historical patterns. It understands how changes interact with existing systems, not just whether individual lines look correct.",
				icon: "BookMarked",
			},
		],
	},
